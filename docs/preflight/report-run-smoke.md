...
- Started: 2026-04-29T12:28:49.965Z
- Finished: 2026-04-29T12:28:50.097Z
- Scenario root: /Users/youjia/.openclaw-worktrees/ddNjGVtI1-Dq4shohdGKo/target/.runs/report-run-smoke/2026-04-29T12-28-49.964Z (removed by finally-cleanup)
...
| stage-failure-mid-run | PASS | Missing edit_en canned prompt produced a non-ok stage result.<br>The composition-root exit-code mapping produced exit 2 for the non-ok stage.<br>run-state.json recorded status=error and lastStage=edit_en. |
...
| resume-carry-forward | PASS | Resume from ok research advanced to draft_en; missing research prompt was never called.<br>research/ and sources.json were copied into attempt-2 with recoveryCleanup recorded. |
