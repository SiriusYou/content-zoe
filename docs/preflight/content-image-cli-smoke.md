...
Generated: 2026-05-29T13:28:08.777Z
...
| static-boundary | PASS | diff from 0909a7b only touches declared Slice 7b files.<br>working-tree boundary included 27 untracked files and explicitly excluded 22 pre-existing W22/W23 report files from the handback set.<br>No real provider smoke or Slice 8 publish files are part of the diff. |
