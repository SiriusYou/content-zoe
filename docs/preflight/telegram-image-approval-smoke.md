...
| unsafe-run-dir-zero-send | PASS | Absolute, parent-traversal, sibling, mismatched, and symlinked run_dir cases failed closed.<br>Each case recorded notify_failed with zero sender calls and no notified event. |
